...
import { bookNewAppointment, getUserData, getUserDataByUrl, sendNewEnquiry } from '../services/api'
...
function Card() {
  ...
  return (
    <Box sx={{height:'100vh'}}>
    {
      ...
      <Box sx={{textAlign:'center', height:'80vh', fontSize:'30px', display:'flex', 
                flexDirection:'column', justifyContent:'center', alignItems:'center', padding:'20px'}}>
        <img src={gocardly} style={styles.logoImg}/>
        This Card Url does not exist
      </Box>
    }
      </> 
    }
